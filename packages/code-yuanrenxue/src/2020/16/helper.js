  ...
  for (var r = n, o = '1|3|0|4|2|5'['split']('|'), a = 0; ; ) {
    switch (o[a++]) {
      ...
      case '1':
        ...
        continue
      case '2':
        for (let i = 0; i < e; i++) c += l['charAt'](Math['floor'](r.bWcgB(Math.random(), s)))
        continue
      case '3':
        var l = r[t(227)]
        continue
...
window[u(208)] = function (e) {
  ...
  for (var o, a, s, l = 0, c = []; l < e[t(261)]; ) {
    console.log('------', l, t(246), t(245), t(212), a, c.toString(' '))

    switch (((a = e[t(237)](l)), (s = i.kukBH(l, 6)))) {
      case 0:
        console.log('0000', 'trigger')

        c[t(246)](f[t(245)](i[t(212)](a, 2)))
        // delete window, delete document, c[t(246)](f[t(245)](i[t(212)](a, 2)))
        break
      case 1:
        // console.log(n.g)
        console.log('1111', 'trigger')
  ...
  //   i[t(219)](i.aQCDK(d(15), window.md5(c['join'](''))), i[t(220)](d, 10))
  // )
  0 == s
    ? i[t(226)](i[t(241)], i[t(195)]) || (c[t(246)](f[t(245)](i[t(201)](o, 3) << 4)), c.push('FM'))
    : i.eMnqD(s, 1) && (c[t(246)](f[t(245)]((15 & o) << 2)), c[t(246)]('K'))

  const d15 = d(15)
  const md5Value = window.md5(c['join'](''))
  const v1 = i.aQCDK(d15, md5Value)
  const v2 = i[t(220)](d, 10)

  console.log(c.toString())
  console.log(d15, md5Value, v1, v2)

  return i[t(219)](v1, v2)
}

export const genSign = e => {
  return window[u(208)](e)
}
  ...
  window.md5 = function (e) {
    ...
    function h(e) {
      for (var n = t, r = i[n(49)], o = '', a = 0; i.iXQwu(a, i[n(74)](e[n(108)], 4)); a++)
        o += i.xgzfr(
          r[n(64)](15 & i[n(36)](e[i[n(36)](a, 2)], i[n(46)](i[n(74)](a % 4, 8), 4))),
...
// console.log(genSign('1703908693000'))
